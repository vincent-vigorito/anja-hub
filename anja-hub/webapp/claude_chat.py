...
SERVER_DESCRIPTIONS = {
    ...
    "anja_hub_runtime": "piano di lavoro degli agent: kanban (create/show/complete/block), goals (judge, journal), agent.list/agent.delegate (@-mention), workspace files, task one-shot schedulati, catalogo Printing Press",
